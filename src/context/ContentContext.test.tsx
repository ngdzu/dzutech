...
const TestConsumer = () => {
  ...
  return (
    <div>
      ...
      <button
        onClick={() =>
          void ctx.updateSite({ title: 'x', description: 'd', homeButtonMode: 'text', logo: null })
        }
      >
        updateSite
      </button>
      ...
      <button onClick={() => void ctx.updateSections({ contact: { description: 'hi' } })}>
        updateSections
      </button>
  ...
  beforeEach(() => {
    ...
    mockFetchContent.mockResolvedValue({
      ...
      profile: {
        ...
        availability: { value: '', enabled: false },
        focusAreas: { value: '', enabled: false },
      },
      posts: [],
      experiences: [],
