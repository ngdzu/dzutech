...
const AdminDashboard = () => {
  ...
  const sectionNav = useMemo(
    () => [
      ...
      // experiences moved to a dedicated admin page
  ...
  // experience editing moved to AdminExperiencesPage
      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-12 px-6 pt-4 pb-12">
        ...
        <div className="flex flex-col gap-10 lg:flex-row">
          ...
          <div className="flex-1 space-y-10">
            ...
            {/* experiences moved to /admin/experiences */}
            ...
            >
              ...
              <div className="space-y-6">
                ...
                {/* Moved experiences, education, programming languages, languages spoken, and achievements editors to /admin/experiences */}
              </div>
              <div className="flex flex-col gap-3 border-t border-slate-800/80 pt-6 sm:flex-row sm:items-center sm:justify-between">
                <div className="text-xs text-slate-500">
