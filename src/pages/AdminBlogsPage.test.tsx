...
describe('AdminBlogsPage', () => {
  ...
  it('shows no tags message when no tags', () => {
    mockContextValue.content = {
      posts: [{ id: 'post-1', title: 'No Tags Post', content: 'Content', tags: [], hidden: false }],
    };
  ...
  it('shows unhide button for hidden posts', () => {
    mockContextValue.content = {
      posts: [{ id: 'post-1', title: 'Hidden Post', content: 'Content', tags: [], hidden: true }],
    };
  ...
  it('shows hide button for visible posts', () => {
    mockContextValue.content = {
      posts: [{ id: 'post-1', title: 'Visible Post', content: 'Content', tags: [], hidden: false }],
    };
  ...
  it('handles keyboard navigation with Enter key', async () => {
    mockContextValue.content = {
      posts: [{ id: 'post-1', title: 'Test Post', content: 'Content', tags: [], hidden: false }],
    };
  ...
  it('shows truncated file list when many files selected', async () => {
    ...
    const files = Array.from(
      { length: 15 },
      (_, i) => new File([`content ${i}`], `file${i}.md`, { type: 'text/markdown' }),
    );
