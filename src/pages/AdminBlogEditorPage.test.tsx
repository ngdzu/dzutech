...
describe('AdminBlogEditorPage', () => {
  ...
  it('opens image uploader and inserts markdown at cursor', async () => {
    ...
    const textarea = screen.getByPlaceholderText(
      /Write or paste the full blog post content\./i,
  ...
  it('prepopulates fields in edit mode and saves changes', async () => {
    ...
    const title = screen.getByPlaceholderText(
      /Introducing resilient frontend architectures/i,
    ) as HTMLInputElement;
    const content = screen.getByPlaceholderText(
      /Write or paste the full blog post content\./i,
    ) as HTMLTextAreaElement;
    const tags = screen.getByPlaceholderText(
      /Engineering, Leadership, Case study/i,
    ) as HTMLInputElement;
