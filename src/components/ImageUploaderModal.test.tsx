...
describe('ImageUploaderModal', () => {
  ...
  it('does not render when isOpen is false', () => {
    render(
      <ImageUploaderModal isOpen={false} onClose={mockOnClose} onImageSelect={mockOnImageSelect} />,
    );
  ...
  it('renders modal when isOpen is true', () => {
    ...
    render(
      <ImageUploaderModal isOpen={true} onClose={mockOnClose} onImageSelect={mockOnImageSelect} />,
    );
  ...
  it.skip('falls back to textarea copy when clipboard API fails', async () => {
    ...
    render(<ImageUploaderModal isOpen={true} onClose={mockOnClose} onImageSelect={undefined} />);
